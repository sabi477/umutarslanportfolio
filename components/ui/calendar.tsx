...
function Calendar({
  ...
  const defaultComponents = React.useMemo(() => ({
    Chevron: (chevronProps: {
      ...
      const size = chevronProps.size ?? 16;
      if (chevronProps.orientation === "left") {
        return (
          <ChevronLeft
            ...
            strokeWidth={2}
            aria-hidden="true"
            className={chevronProps.className}
          />
        );
      }
